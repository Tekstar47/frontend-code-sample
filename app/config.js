var APP_NAME = 'mymarketpluswithtenant';
var REPORT_ALL_PRODUCTS = 'All_Product_Image_Banks_Widget_View';
var REPORT_ALL_CUSTOMER_PRICES = 'Master_Price_File_Report';
var REPORT_NEW_WEB_SALES_CATEGORY = 'New_Web_Sales_Category';
var REPORT_CART_PURCHASES = 'Cart_Purchases';
var REPORT_CUSTOMER_PRICES = 'Master_Price_File_Report';
var FORM_SCAN_PURCHASES_CART = 'Scan_Purchases_Cart';
var REPORT_ALL_TECHNICAL_DATA_SHEETS = 'Technical_Data_File_Report';
var REPORT_ALL_SAFETY_DATA_SHEETS = 'Safety_Data_Sheets1_Report';
var REPORT_SHIPMENT_UPDATES = 'ShipmentUpdates_Report';
var REPORT_TENANT = 'Get_Tenant_Widget_View';
var REPORT_IN_STOCK_PRODUCTS = 'In_Stock_Products_Widget_View';
var REPORT_MARKETING_SPECIALS = 'AddMarketingSpecial_Report';
var LOCAL_NUMBER_FORMAT = 'en-AU';
var MESSAGE_TIMEOUT = 3000;
var MAXIMUM_FILTER_VALUES_BEFORE_VIEW_ALL = 4;
var IMAGE_WIDTH = '50px';
var MINIMUM_TABLE_ROWS = 5;
var TABLE_SHIPPING_AVAILABILITY_ORDER = ['NSW', 'NZ', 'QLD', 'VIC', 'WA'];
var SUPPLIER_ZID = '3932514000007121003'; // Hard coded supplier ZID
